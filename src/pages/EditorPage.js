...
const EditorPage = () => {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        // Consider debouncing this call if code changes frequently
        // sendCodeToServer(); // Uncomment this line if you want to auto-send on change
      }, [currentCode]);
    ...
    const sendCodeToServer = async () => {
        try {
          const response = await fetch('http://localhost:10000/compilecode', {
            method: 'POST',
            headers: {
          ...
          console.error(error);
          setServerResponse({ error: 'Failed to fetch data' });
        }
    };
    ...
    return (
        <div className="mainWrap">
            <div className="aside">
                ...
                <button onClick={() => sendCodeToServer()} className='btn compileBtn'>
                    Comiple Code
                </button>
                <a target="_blank" href="https://chat-gpt-chatbot.vercel.app/" >
                    <button className="btn gptBtn"  type="button">
                    Use ChatGPT
                </button></a>
                ...
                <div className="terminalOutput">
                 ...
                 {!serverResponse && <p>Terminal Output...</p>}
                 </div>
            </div>
